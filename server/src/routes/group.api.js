...
// @route POST/group
// @desc create a new group (groupForm)
// @body (userId, name, description, categories, interests..)
// @access login required
// creator is first group.members
router.post(
  '/',
...
// @route GET/group
// @desc get list of group & interest & search
...
// @desc join a group (add user into members list)
// @body (userId, groupId)
// @access login required
router.put(
  '/:groupId/:userId',
...
// @desc leave a group (delete user in members list)
// @body (userId, groupId)
// @access login required
router.delete(
  '/:groupId',
...
// @desc get list of members (memberList)
// @body (userId, groupId)
// @access login required
router.get(
  '/',
...
// @desc create a new post in the group (postForm)
...
// @desc get list of posts in group(postList)
